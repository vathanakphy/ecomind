    ...
    eng:{
        ...
        missionSelectScreen: {
            ...
            oceanMission: {
                ...
                description: "The oceans are choking with plastic. Train your AI to identify and help remove it!"
            },
            forestMission: {
                heading: "Forest Guardian",
                descriptionUnlocked: "Reduce global CO₂ by managing a vital forest ecosystem.",
        ...
        "gameGuideForest": {
                ...
                "trainWardenPurpose": "button to teach it how to spot threats like disease and fire risk. This increases your",
                ...
                "priority1Desc": "If the AI finds a diseased or fire risk tile, it will fix it automatically.",
                "priority2Title": "Priority 2: Reforestation",
                "priority2Desc": "If no threats are found, the AI will plant new saplings to help the forest grow.",
                "section2_li2_part1": "Click",
                "section2_li2_part2": "to open the planting menu and manually plant trees using your Data Points.",
                
                "section3Title": "Advanced Strategies",
                "section3_li1_part1": "Use the",
                "section3_li1_part2": "button to get permanent improvements like Solar Panels for passive energy, or the",
                "section3_li1_part3": "for a quick energy boost from stumps.",
                "section3_li2_part1": "If you need energy, you can log parts of your forest and use the",
         ...
         "gameGuideOcean": {
            ...
            "section1_li1_part2": "and keep it high. It represents the cleanliness of the ocean.",
            ...
            "section2_p1": "The ocean is full of trash! Your job is to train your AI to identify different types of pollution.",
            "section2_li1_part1": "Click",
            "section2_li1_part2": "to enter the 'Sort the Trash' minigame.",
            "section2_li2_part1": "Drag and drop the falling trash items into the correct bins:",
            ...
            "section2_p2": "The higher your AI's accuracy, the more effective your deployments will be!",
            ...
            "section3_li2_part1": "Deploying your AI will consume resources but directly improve the",
            "section3_li2_part2": ".",
            "section3_li3_part1": "Visit the",
            "section3_li3_part2": "section to spend your Data Points on permanent improvements, like making your AI clean more efficiently.",
            "section3_li4": "Keep training, deploying, and upgrading until the ocean is sparkling clean!",
         ...
         "alertsLowEnergy": {
            "lowEnergyTitle": "Low Energy Alert! purchasing Solar Panels from the Upgrades ",
            "lowEnergyMessagePart1": "Your energy reserves are critically low. You might not be able to deploy AI or train!",
            "lowEnergyMessagePart2": "Consider purchasing Solar Panels from the Upgrades menu to generate energy automatically over time.",
            "gotItButton": "Got It"
        }
    },
        kh:{
        ...
        missionSelectScreen: {
            ...
            oceanMission: {
                ...
                description: "មហាសមុទ្រកំពុងតែរងការបំពុលដោយសារប្លាស្ទិក។ បណ្តុះបណ្តាល AI របស់អ្នកឱ្យកំណត់ប្រភេទប្លាស្ទិក និងជួយប្រមូលសម្រាម!"
            },
            forestMission: {
                heading: "អ្នកយាមព្រៃឈើ",
                descriptionUnlocked: "កាត់បន្ថយ CO₂ សកលលោកដោយគ្រប់គ្រងប្រព័ន្ធអេកូឡូស៊ីព្រៃឈើដ៏សំខាន់។",
        ...
        "gameGuideForest": {
            ...
            "trainWardenPurpose": "ដើម្បីបង្រៀនវាអោយស្គាល់ហានិភ័យដូចជារោគសញ្ញា និងហានិភ័យអគ្គីភ័យ។ វានឹងបង្កើន",
            "trainWardenReward": "និងធ្វើអោយអ្នកទទួលបានពិន្ទុទិន្នន័យដោយឥតគិតថ្លៃ",
            "deployWardenIntro": "ចុច",
            "deployWardenLogic": "ដើម្បីផ្ញើវាអោយធ្វើការស្វែងរកសុខភាព។ វាមានអាទិភាពពីរចម្បង៖",
            "priority1Title": "អាទិភាពទី 1៖ បំភាយហានិភ័យ",
            "priority1Desc": "បើ AI រកឃើញផ្ទៃដីដែលមានជំងឺ ឬហានិភ័យអគ្គីភ័យ វានឹងដោះស្រាយដោយស្វ័យប្រវត្តិ។",
            "priority2Title": "អាទិភាពទី 2៖ ដាំព្រៃឡើងវិញ",
            "priority2Desc": "បើមិនមានហានិភ័យណាដែលត្រូវដោះស្រាយទេ AI នឹងដាំដើមឈើថ្មី ដើម្បីឲ្យព្រៃលូតលាស់ឡើងវិញ។",
            "section2_li2_part1": "ចុច",
            "section2_li2_part2": "ដើម្បីបើកម៉ឺនុយដាំដើមឈើ និងដាំដោយដៃដោយប្រើពិន្ទុទិន្នន័យ។",
            
            "section3Title": "យុទ្ធសាស្ត្រចម្រើន",
            "section3_li1_part1": "ប្រើប៊ូតុង",
            "section3_li1_part2": "ដើម្បីទទួលបានការកែលម្អអចិន្ត្រៃយ៍ ដូចជា បន្ទះសូឡា សម្រាប់ថាមពលសកម្ម ឬ",
...
,
        "gameGuideOcean": {
            ...
            "section1_li3": "ជំនួយការ AI របស់អ្នកនឹងផ្តល់គន្លឹះ និងការណែនាំមានប្រយោជន៍។",

            "section2Title": "2. វដ្តនៃការលេងហ្គេមស្នូល: តម្រៀបសំរាម",
            "section2_p1": "មហាសមុទ្រពោរពេញដោយសំរាម! ភារកិច្ចរបស់អ្នកគឺបណ្តុះបណ្តាល AI របស់អ្នកឱ្យកំណត់អត្តសញ្ញាណប្រភេទនៃការបំពុលផ្សេងៗគ្នា។",
            "section2_li1_part1": "ចុច",
            "section2_li1_part2": "ដើម្បីចូលទៅកាន់មីនីហ្គេម 'តម្រៀបសំរាម'។",
            "section2_li2_part1": "អូសនិងទម្លាក់វត្ថុសំរាមដែលធ្លាក់ចូលទៅក្នុងធុងត្រឹមត្រូវ៖",
            ...
            "section2_p2": "ភាពត្រឹមត្រូវរបស់ AI របស់អ្នកកាន់តែខ្ពស់ ការដាក់ពង្រាយរបស់អ្នកកាន់តែមានប្រសិទ្ធភាព!",
            ...
            "section3_li2_part1": "ការដាក់ពង្រាយ AI របស់អ្នកនឹងប្រើប្រាស់ធនធាន ប៉ុន្តែដោយផ្ទាល់បង្កើន",
            "section3_li2_part2": "។",
            "section3_li3_part1": "ចូលទៅកាន់ផ្នែក",
            "section3_li3_part2": "ដើម្បីចំណាយពិន្ទុទិន្នន័យរបស់អ្នកលើការកែលម្អជាអចិន្ត្រៃយ៍ ដូចជាការធ្វើឱ្យ AI របស់អ្នកសម្អាតបានកាន់តែមានប្រសិទ្ធភាព។",
            "section3_li4": "បន្តបណ្តុះបណ្តាល ដាក់ពង្រាយ និងអាប់ដេតរហូតទាល់តែមហាសមុទ្រស្អាតបាត!",
        ...
        "alertsLowEnergy": {
            "lowEnergyTitle": "ការជូនដំណឹងថាមពលទាប! ពិចារណាទិញ បន្ទះសូឡា ពីម៉ឺនុយ ការអាប់ដេត ",
            "lowEnergyMessagePart1": "ថាមពលបម្រុងរបស់អ្នកទាបណាស់។ អ្នកប្រហែលជាមិនអាចដាក់ពង្រាយ AI ឬហ្វឹកហាត់បានទេ!",
            "lowEnergyMessagePart2": "ពិចារណាទិញ **បន្ទះសូឡា** ពីម៉ឺនុយ **ការអាប់ដេត** ដើម្បីបង្កើតថាមពលដោយស្វ័យប្រវត្តិទៅតាមពេលវេលា។",
            "gotItButton": "យល់ហើយ"
      }
    },
}