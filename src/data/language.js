  ...
  eng: {
    ...
    cityAITraining: {
      ...
      proposals: {
        ...
        ctp1_desc: "A developer wants to build a new public park downtown, increasing green space and reducing the heat island effect.",
        ctp2_title: "Build a New Highway Through Suburbs",
        ctp2_desc: "This would increase traffic and pollution in a residential area, prioritizing cars over people.",
        ctp3_title: "Dump Industrial Waste in River",
        ctp3_desc: "A factory is proposing a cheaper, but highly polluting, way to get rid of its chemical waste.",
        ctp4_title: "Community Composting Program",
        ctp4_desc: "A city-wide initiative to collect food scraps and reduce the amount of organic waste going to the landfill.",
        ctp5_title: "Remove Emission Standards for Cars",
        ctp5_desc: "A proposal to make it cheaper to own older, more polluting cars, which would worsen air quality.",
        ctp6_title: "Switch Streetlights to Low-Energy LEDs",
        ctp6_desc: "This will reduce the city's overall energy consumption and lower its carbon footprint.",
        ctp7_title: "Expand the Public Bus System",
        ctp7_desc: "Adding more bus routes to reduce reliance on personal motos and cars, easing traffic congestion and emissions.",
        ctp8_title: "Fill in a Natural Lake for a New Mall",
        ctp8_desc: "A plan to reclaim a large urban lake for a luxury shopping center, destroying a vital natural wetland.",
        ctp9_title: "Subsidize Rooftop Solar Panels",
        ctp9_desc: "Offer financial help for homes and businesses to install solar panels, promoting clean, renewable energy.",
        ctp10_title: "Encourage Single-Use Plastic Bags",
        ctp10_desc: "A proposal to give out free, non-biodegradable plastic bags at all markets to increase customer convenience.",
        ctp11_title: "Install Public Water Filtration Stations",
        ctp11_desc: "Provide free, clean drinking water in public spaces to reduce the widespread use of plastic water bottles.",
        ctp12_title: "Import Cheap, Unregulated Two-Stroke Motos",
        ctp12_desc: "Allow the import of older, less efficient motorbikes that produce a large amount of smoke and noise pollution.",
        ctp13_title: "Mandate Green Roofs on New Buildings",
        ctp13_desc: "Require new commercial buildings to have gardens on their roofs to help cool the city and manage rainwater.",
        ctp14_title: "Create Protected Bicycle Lanes",
        ctp14_desc: "Build a network of safe, separated bike lanes across the city to encourage carbon-free transportation.",
        ctp15_title: "Build a Coal Power Plant on City Outskirts",
        ctp15_desc: "A proposal to generate cheap electricity for the city by burning coal, a major source of air pollution and CO₂.",
        ctp16_title: "Build a Modern Waste-to-Energy Plant",
        ctp16_desc: "Process non-recyclable city trash in a high-tech incinerator to generate electricity, reducing landfill size.",
        ctp17_title: "Allow Construction Work 24/7",
        ctp17_desc: "Remove restrictions on construction hours to speed up projects, leading to constant noise pollution in neighborhoods.",
        ctp18_title: "Convert Vacant Lots into Community Farms",
        ctp18_desc: "Allow citizens to grow their own food in unused city spaces, promoting local food security and greening the area.",
        ctp19_title: "Pave Over Riverside Greenways for Parking",
        ctp19_desc: "Remove natural riverfront parks and green spaces to create more parking lots for cars.",
        ctp20_title: "Offer Incentives for Electric Tuk-Tuks",
        ctp20_desc: "Provide loans or grants for drivers to switch from gasoline-powered tuk-tuks to silent, non-polluting electric models.",
        ctp21_title: "Delay Upgrades to Sewage Treatment System",
        ctp21_desc: "Postpone essential maintenance on the city's wastewater treatment plants, risking raw sewage leaks into waterways.",
        ctp22_title: "Create Car-Free Pedestrian Zones",
        ctp22_desc: "Designate popular market and riverside areas as \"walking only\" on weekends to improve safety and air quality.",
        ctp23_title: "Allow Loudspeaker Advertising Trucks",
        ctp23_desc: "Permit vehicles to drive through neighborhoods broadcasting loud advertisements at all hours, increasing noise pollution.",
        ctp24_title: "Promote Rainwater Harvesting Systems",
        ctp24_desc: "Encourage buildings to collect and store rainwater for non-drinking uses, reducing strain on the city's water supply.",
        ctp25_title: "Ban All Street Food Vendors",
        ctp25_desc: "A plan to \"clean up the streets\" by banning all street food vendors, which harms local culture and small businesses."
      }
    },
    cityMissionScreen: {
    ...
    forestAITraining: {
      ...
      endTraining: "End Training",
      descriptions: {
        "desc_1": "Drone footage shows a dense, closed canopy with vibrant, uniform green coloration across the upper branches.",
        "desc_2": "A close-up image of leaves shows distinct necrotic lesions (brown spots) and significant wilting along the edges.",
        "desc_3": "Thermal analysis indicates extremely low moisture content in the ground-level foliage and a thick layer of dry tinder.",
        "desc_4": "The forest floor is covered in a diverse array of ferns, mosses, and wildflowers, indicating rich soil and ample water.",
        "desc_5": "Patches of pine trees are showing browning needles and small holes in the bark, consistent with beetle infestation.",
        "desc_6": "A clearing shows numerous young saplings successfully taking root and showing vigorous new leaf growth.",
        "desc_7": "Image analysis reveals a large, oozing canker on the main trunk of a tree, a sign of a severe fungal infection.",
        "desc_8": "Lidar data shows a high density of standing dead trees with very low moisture content, acting as potential \"ladder fuels\".",
        "desc_9": "Sensor data shows high water clarity in a forest stream, indicating minimal soil erosion and a stable ecosystem.",
        "desc_10": "Visible decay and fungal mycelium are present at the base of several mature trees, pointing to widespread root rot.",
        "desc_11": "A tall, isolated tree shows a long, fresh scar down its trunk from a recent lightning strike, making it susceptible to ignition.",
        "desc_12": "A remote camera trap has captured multiple images of deer and other small mammals foraging, indicating a robust food web.",
        "desc_13": "Thermal imaging indicates significant water stress across a sector; the leaves on many trees are curled and losing turgor.",
        "desc_14": "A fallen log is covered in thick moss and various fungi, actively decomposing and recycling nutrients back into the soil.",
        "desc_15": "High-resolution image shows a pattern of small boreholes in tree bark with \"frass\" (a sawdust-like substance) accumulating below.",
        "desc_16": "A vibrant forest with many trees and birds. The scene includes various bird species singing at different pitches, creating a rich and lively soundscape. This diverse audio activity reflects a healthy, biodiverse ecosystem.",
        "desc_17": "Image analysis identifies numerous low-hanging dead branches on mature trees, which could carry a ground fire into the canopy.",
        "desc_18": "A tree is showing multiple instances of \"witches' broom\" – a dense, chaotic mass of twig growth caused by a pathogen.",
        "desc_19": "Drone close-up of several tree trunks shows bark is intact and healthy, with no signs of peeling or deep cracks.",
        "desc_20": "Field sensors detect large patches of a non-native, invasive grass species that has dried out completely, creating a continuous fuel source.",
        "desc_21": "Analysis of ground cover shows a significant number of leaves have been shed from deciduous trees far ahead of the normal season.",
        "desc_22": "Sub-surface soil scan reveals a dense and thriving network of mycorrhizal fungi interconnected with tree roots.",
        "desc_23": "A remote camera has spotted a smoldering, unattended campfire at an unauthorized campsite within the forest boundary.",
        "desc_24": "Magnified leaf image shows distinctive winding tunnels and trails within the leaf tissue, indicating a leaf miner insect infestation.",
        "desc_25": "Image of a muddy path shows a variety of fresh animal tracks, including boar and deer, suggesting active animal populations."
      },
      tutorial: {
  ...
  kh: {
    ...
    cityAITraining: {
      ...
      proposals: {
        ...
        ctp1_desc: "អ្នកអភិវឌ្ឍន៍ម្នាក់ចង់សាងសង់សួនសាធារណៈថ្មីមួយនៅកណ្តាលទីក្រុង ដើម្បីបង្កើនដើមឈើបៃតង និងកាត់បន្ថយឥទ្ធិពលកោះកំដៅ។",
        ctp2_title: "សាងសង់ផ្លូវហាយវេថ្មីឆ្លងកាត់ជាយក្រុង",
        ctp2_desc: "នេះនឹងបង្កើនចរាចរណ៍ និងការបំពុលនៅក្នុងតំបន់លំនៅដ្ឋាន ដោយផ្តល់អាទិភាពដល់រថយន្តលើមនុស្ស។",
        ctp3_title: "ចាក់កាកសំណល់ឧស្សាហកម្មចូលទន្លេ",
        ctp3_desc: "រោងចក្រមួយកំពុងស្នើវិធីចំណាយតិច ប៉ុន្តែមានភាពបំពុលខ្លាំង ដើម្បីកម្ចាត់កាកសំណល់គីមីរបស់ខ្លួន។",
        ctp4_title: "សហគមន៍ធ្វើជីកំប៉ុស្ត",
        ctp4_desc: "គំនិតផ្តួចផ្តើមទូទាំងទីក្រុងដើម្បីប្រមូលសំណល់អាហារ និងកាត់បន្ថយបរិមាណសំណល់សរីរាង្គដែលទៅកន្លែងចាក់សំរាម។",
        ctp5_title: "លុបចោលស្តង់ដារបំភាយឧស្ម័នសម្រាប់រថយន្ត",
        ctp5_desc: "សំណើដើម្បីធ្វើឱ្យការកាន់កាប់រថយន្តចាស់ៗ ដែលបំពុលច្រើន មានតម្លៃថោក ដែលនឹងធ្វើឱ្យគុណភាពខ្យល់កាន់តែអាក្រក់។",
        ctp6_title: "ប្តូរភ្លើងបំភ្លឺផ្លូវទៅជាអំពូល LED ដែលស៊ីភ្លើងតិច",
        ctp6_desc: "នេះនឹងកាត់បន្ថយការប្រើប្រាស់ថាមពលសរុបរបស់ទីក្រុង និងកាត់បន្ថយការបំភាយកាបូនរបស់វា។",
        ctp7_title: "ពង្រីកប្រព័ន្ធរថយន្តក្រុងសាធារណៈ",
        ctp7_desc: "បន្ថែមផ្លូវរថយន្តក្រុងបន្ថែមទៀតដើម្បីកាត់បន្ថយការពឹងផ្អែកលើម៉ូតូ និងរថយន្តផ្ទាល់ខ្លួន កាត់បន្ថយការកកស្ទះចរាចរណ៍ និងការបំភាយឧស្ម័ន។",
        ctp8_title: "ចាក់បំពេញបឹងធម្មជាតិសម្រាប់ផ្សារទំនើបថ្មី",
        ctp8_desc: "គម្រោង​ទាមទារ​យក​បឹង​ក្នុង​ទីក្រុង​ធំ​មួយ​សម្រាប់ធ្វើ​មជ្ឈមណ្ឌល​លក់​ទំនិញ​ប្រណីត បំផ្លាញ​ដីសើម​ធម្មជាតិ​។",
        ctp9_title: "ឧបត្ថម្ភធនបន្ទះសូឡាលើដំបូល",
        ctp9_desc: "ផ្តល់ជំនួយហិរញ្ញវត្ថុសម្រាប់ផ្ទះ និងអាជីវកម្មដើម្បីដំឡើងបន្ទះសូឡា ជំរុញថាមពលស្អាត ។",
        ctp10_title: "លើកទឹកចិត្តការប្រើប្រាស់ថង់ប្លាស្ទិកប្រើតែម្តង",
        ctp10_desc: "សំណើផ្តល់ថង់ប្លាស្ទិកដែលមិនអាចរលួយដោយឥតគិតថ្លៃនៅគ្រប់ទីផ្សារ ដើម្បីបង្កើនភាពងាយស្រួលរបស់អតិថិជន។",
        ctp11_title: "ដំឡើងស្ថានីយ៍ចម្រោះទឹកសាធារណៈ",
        ctp11_desc: "ផ្តល់ទឹកស្អាតដែលអាចផឹកបានដោយឥតគិតថ្លៃនៅក្នុងទីសាធារណៈ ដើម្បីកាត់បន្ថយការប្រើប្រាស់ដបទឹកប្លាស្ទិក។",
        ctp12_title: "នាំចូលម៉ូតូពីរហ្វាដែលថោក និងគ្មានបទប្បញ្ញត្តិ",
        ctp12_desc: "អនុញ្ញាតឱ្យនាំចូលម៉ូតូចាស់ៗ ដែលមានប្រសិទ្ធភាពទាប ដែលផលិតផ្សែង និងសំឡេងរំខានច្រើន។",
        ctp13_title: "តម្រូវឱ្យមានរុក្ខជាតិបៃតងលើអគារថ្មី",
        ctp13_desc: "តម្រូវឱ្យអគារពាណិជ្ជកម្មថ្មីមានសួនច្បារនៅលើដំបូលរបស់ពួកគេ ដើម្បីជួយធ្វើឱ្យទីក្រុងត្រជាក់ និងគ្រប់គ្រងទឹកភ្លៀង។",
        ctp14_title: "បង្កើតផ្លូវជិះកង់ការពារ",
        ctp14_desc: "សាងសង់បណ្តាញផ្លូវជិះកង់ដែលមានសុវត្ថិភាព និងបំបែកគ្នាពាសពេញទីក្រុង ដើម្បីលើកទឹកចិត្តការដឹកជញ្ជូនដែលគ្មានកាបូន។",
        ctp15_title: "សាងសង់រោងចក្រថាមពលធ្យូងថ្មនៅជាយក្រុង",
        ctp15_desc: "សំណើដើម្បីបង្កើតអគ្គិសនីថោកសម្រាប់ទីក្រុងដោយការដុតធ្យូងថ្ម ដែលជាប្រភពសំខាន់នៃការបំពុលខ្យល់ និង CO₂។",
        ctp16_title: "សាងសង់រោងចក្រកាកសំណល់ទៅថាមពលទំនើប",
        ctp16_desc: "កែច្នៃសំរាមទីក្រុងដែលមិនអាចកែច្នៃបាននៅក្នុងឡដុតកម្រិតខ្ពស់ដើម្បីបង្កើតអគ្គិសនី កាត់បន្ថយទំហំកន្លែងចាក់សំរាម។",
        ctp17_title: "អនុញ្ញាតការងារសំណង់ 24/7",
        ctp17_desc: "លុបចោលការរឹតបន្តឹងលើម៉ោងសំណង់ដើម្បីពន្លឿនគម្រោង ដែលនាំឱ្យមានការបំពុលសំឡេងឥតឈប់ឈរនៅក្នុងសង្កាត់។",
        ctp18_title: "បំប្លែងដីទទេទៅជាកសិដ្ឋានសហគមន៍",
        ctp18_desc: "អនុញ្ញាតឱ្យប្រជាពលរដ្ឋដាំដុះអាហារផ្ទាល់ខ្លួនរបស់ពួកគេនៅក្នុងទីក្រុងដែលមិនប្រើប្រាស់ ជំរុញសន្តិសុខស្បៀងក្នុងស្រុក និងធ្វើឱ្យតំបន់នោះមានរុក្ខជាតិពណ៌បៃតង។",
        ctp19_title: "ក្រាលកៅស៊ូលើផ្លូវលើរុក្ខជាតិបៃតងតាមមាត់ទន្លេសម្រាប់ធ្វើចំណត",
        ctp19_desc: "លុបបំបាត់ឧទ្យានធម្មជាតិមាត់ទន្លេ និងកន្លែងបៃតងដើម្បីបង្កើតចំណតរថយន្តបន្ថែមទៀត។",
        ctp20_title: "ផ្តល់ការលើកទឹកចិត្តសម្រាប់រ៉ឺម៉កអគ្គិសនី",
        ctp20_desc: "ផ្តល់ប្រាក់កម្ចី ឬជំនួយសម្រាប់អ្នកបើកបរដើម្បីប្តូរពីម៉ូតូកង់បីដែលប្រើសាំងទៅជាម៉ូដែលអគ្គិសនីដែលគ្មានសំឡេង និងគ្មានការបំពុល។",
        ctp21_title: "ពន្យារពេលការដំឡើងកំណែប្រព័ន្ធប្រព្រឹត្តិកម្មលូ",
        ctp21_desc: "ពន្យារពេលការថែទាំសំខាន់ៗលើរោងចក្រប្រព្រឹត្តិកម្មទឹកស្អុយរបស់ទីក្រុង ប្រថុយនឹងការលេចធ្លាយទឹកស្អុយឆៅចូលទៅក្នុងផ្លូវទឹក។",
        ctp22_title: "បង្កើតតំបន់ថ្មើរជើងគ្មានរថយន្ត", "ctp22_desc": "កំណត់តំបន់ផ្សារ និងមាត់ទន្លេដ៏ពេញនិយមជាតំបន់ 'ដើរតែប៉ុណ្ណោះ' នៅចុងសប្តាហ៍ ដើម្បីកែលម្អសុវត្ថិភាព និងគុណភាពខ្យល់។",
        ctp23_title: "អនុញ្ញាតរថយន្តផ្សាយពាណិជ្ជកម្ម",
        ctp23_desc: "អនុញ្ញាតឱ្យយានយន្តបើកបរឆ្លងកាត់សង្កាត់ផ្សាយពាណិជ្ជកម្មខ្លាំងៗគ្រប់ម៉ោង បង្កើនការបំពុលសំឡេង។",
        ctp24_title: "លើកកម្ពស់ប្រព័ន្ធប្រមូលទឹកភ្លៀង",
        ctp24_desc: "លើកទឹកចិត្តអគារឱ្យប្រមូល និងស្តុកទឹកភ្លៀងសម្រាប់ប្រើប្រាស់ដែលមិនមែនជាការផឹក កាត់បន្ថយសម្ពាធលើការផ្គត់ផ្គង់ទឹករបស់ទីក្រុង។",
        ctp25_title: "ហាមឃាត់អ្នកលក់អាហារតាមផ្លូវទាំងអស់",
        ctp25_desc: "ផែនការ 'សម្អាតផ្លូវ' ដោយហាមឃាត់អ្នកលក់អាហារតាមផ្លូវទាំងអស់ ដែលប៉ះពាល់ដល់វប្បធម៌ក្នុងស្រុក និងអាជីវកម្មខ្នាតតូច។"
      }
    },
    cityMissionScreen: {
    ...
    forestAITraining: {
      ...
      endTraining: "បញ្ចប់ការបណ្តុះបណ្តាល",
      descriptions: {
        "desc_1": "រូបភាពពីដ្រូនបង្ហាញពីគម្របព្រៃឈើក្រាស់ មានពណ៌បៃតងស្រស់ស្អាតដូចគ្នា នៅលើមែកឈើខាងលើ។",
        "desc_2": "រូបភាពស្លឹកឈើជិតៗបង្ហាញពីចំណុចក្រហមត្នោត (ចំណុចងាប់) និងក្រៀមស្វិតខ្លាំងនៅតាមគែមស្លឹក។",
        "desc_3": "ការវិភាគកម្ដៅបង្ហាញថា ដីនៅជិតផ្ទៃខាងក្រោមមានសំណើមទាបបំផុត ហើយមានស្រទាប់ឈើស្ងួតក្រាស់។",
        "desc_4": "ផ្ទៃព្រៃត្រូវបានគ្របដណ្ដប់ដោយរុក្ខជាតិហ្វឺន ស្មៅ និងផ្កាព្រៃជាច្រើនប្រភេទ ដែលបង្ហាញពីដីមានជីជាតិ និងទឹកច្រើន។",
        "desc_5": "ដើមស្រល់មួយចំនួនបង្ហាញពីម្ជុលប្រែពណ៌ត្នោត និងប្រហោងតូចៗនៅលើសំបកឈើ ដែលត្រូវនឹងការបំផ្លាញដោយសត្វល្អិត។",
        "desc_6": "កន្លែងវាលស្មៅបង្ហាញពីកូនឈើតូចៗជាច្រើនកំពុងដុះលូតលាស់ល្អ និងមានស្លឹកខ្ចីៗ។",
        "desc_7": "ការវិភាគរូបភាពបង្ហាញពីដំបៅធំមួយនៅលើដើមឈើមេ ដែលជាសញ្ញានៃការឆ្លងមេរោគផ្សិតធ្ងន់ធ្ងរ។",
        "desc_8": "ទិន្នន័យ Lidar បង្ហាញពីដង់ស៊ីតេខ្ពស់នៃដើមឈើងាប់ៗ ដែលមានសំណើមទាបបំផុត អាចក្លាយជាឥន្ធនៈងាយឆេះ។",
        "desc_9": "ទិន្នន័យឧបករណ៏ចាប់សញ្ញាបង្ហាញពីភាពថ្លានៃទឹកអូរក្នុងព្រៃ ដែលបង្ហាញពីសំណឹកដីតិចតួច និងប្រព័ន្ធអេកូឡូស៊ីមានស្ថិរភាព។",
        "desc_10": "ការរលួយ និងផ្សិតអាចមើលឃើញនៅគល់ដើមឈើធំៗជាច្រើន ដែលបង្ហាញពីការរលួយឫសរីករាលដាល។",
        "desc_11": "ដើមឈើខ្ពស់ឯកោមួយបង្ហាញពីស្លាកស្នាមស្រស់ៗនៅលើដើមរបស់វាពីការបាញ់រន្ទះថ្មីៗ ដែលធ្វើឱ្យវាងាយឆេះ។",
        "desc_12": "ម៉ាស៊ីនថតកាមេរ៉ាពីចម្ងាយបានថតរូបសត្វក្តាន់ និងសត្វតូចៗផ្សេងទៀតកំពុងរកស៊ី ដែលបង្ហាញពីបណ្ដាញអាហាររឹងមាំ។",
        "desc_13": "រូបភាពកម្ដៅបង្ហាញពីកង្វះទឹកគួរឱ្យកត់សម្គាល់នៅទូទាំងតំបន់។ ស្លឹកឈើជាច្រើនបានរួញ និងបាត់បង់ជាតិទឹក។",
        "desc_14": "គល់ឈើដែលដួលរលំត្រូវបានគ្របដណ្ដប់ដោយស្មៅ និងផ្សិតផ្សេងៗ ដែលកំពុងពុកផុយ និងផ្ដល់សារធាតុចិញ្ចឹមត្រឡប់ទៅក្នុងដីវិញ។",
        "desc_15": "រូបភាពកម្រិតច្បាស់ខ្ពស់បង្ហាញពីលំនាំនៃប្រហោងតូចៗនៅលើសំបកឈើ ជាមួយនឹងកាកសំណល់ឈើ (ដូចជាធូលីដី) កកកុញនៅខាងក្រោម។",
        "desc_16": "ព្រៃឈើដែលមានដើមឈើ និងសត្វស្លាបជាច្រើន។ ទេសភាពនេះរួមបញ្ចូលទាំងប្រភេទសត្វស្លាបជាច្រើនប្រភេទកំពុងច្រៀងដោយសំឡេងផ្សេងៗគ្នា បង្កើតបានជាទេសភាពសំឡេងដ៏សម្បូរបែប និងរស់រវើក។ សកម្មភាពសំឡេងចម្រុះនេះឆ្លុះបញ្ចាំងពីប្រព័ន្ធអេកូឡូស៊ីដែលមានសុខភាពល្អ និងសម្បូរបែប។",
        "desc_17": "ការវិភាគរូបភាពកំណត់អត្តសញ្ញាណមែកឈើងាប់ជាច្រើននៅទាបនៅលើដើមឈើធំៗ ដែលអាចនាំឱ្យភ្លើងពីដីឆេះដល់គម្របព្រៃ។",
        "desc_18": "ដើមឈើមួយបង្ហាញពីសភាពដូច \"អំបោសធ្មប់\" – ជាដុំមែកឈើដុះច្របូកច្របល់ដែលបណ្ដាលមកពីមេរោគ។",
        "desc_19": "រូបភាពដ្រូនជិតៗនៃដើមឈើជាច្រើនបង្ហាញថា សំបកឈើនៅដដែល និងមានសុខភាពល្អ គ្មានសញ្ញានៃការរបក ឬប្រេះជ្រៅៗឡើយ។",
        "desc_20": "ឧបករណ៏ចាប់សញ្ញានៅក្នុងព្រៃរកឃើញស្មៅជាច្រើនប្រភេទដែលមិនមែនជាស្មៅក្នុងស្រុក បានរីងស្ងួតទាំងស្រុង បង្កើតបានជាប្រភពឥន្ធនៈបន្ត។",
        "desc_21": "ការវិភាគគម្របដីបង្ហាញពីចំនួនស្លឹកឈើជាច្រើនបានជ្រុះចេញពីដើមឈើជ្រុះស្លឹក លឿនជាងរដូវធម្មតា។",
        "desc_22": "ការស្កេនដីក្រោមដីបង្ហាញពីបណ្ដាញផ្សិត mycorrhizal ក្រាស់ និងលូតលាស់ល្អ ដែលភ្ជាប់ជាមួយឫសឈើ។",
        "desc_23": "កាមេរ៉ាពីចម្ងាយបានប្រទះឃើញភ្លើងឆេះគគុកដែលមិនមានអ្នកមើលថែនៅកន្លែងបោះជំរុំខុសច្បាប់នៅក្នុងព្រៃ។",
        "desc_24": "រូបភាពស្លឹកឈើដែលពង្រីកបង្ហាញពីផ្លូវរូងក្រោមដី និងគន្លងប្លែកៗនៅក្នុងជាលិកាស្លឹក ដែលបង្ហាញពីការបំផ្លាញដោយសត្វល្អិតខាំស៊ីស្លឹក។",
        "desc_25": "រូបភាពផ្លូវភក់បង្ហាញពីដានជើងសត្វស្រស់ៗជាច្រើនប្រភេទ រួមទាំងជ្រូកព្រៃ និងក្តាន់ ដែលបង្ហាញពីចំនួនសត្វសកម្ម។"
      },
      tutorial: {
